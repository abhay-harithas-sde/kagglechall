"""
canonical_answers_v15.py
========================
v15: v12 base + Q03 Maternity Act citation + Q04 "If an employee" framing +
     Q10 with approval process detail.

Testing if:
- Q03: Adding "in accordance with the Maternity Benefit (Amendment) Act, 2017" helps
- Q04: "If an employee takes sick leave for more than 2 consecutive days" framing
       matches how question is asked (question echoing style from v4)
- Q10: Add "Employees must submit a WFH request through the ZyroHR portal at least
       2 working days before the intended WFH date" as approval context
"""
...
ANSWERS = {
    ...
    # Add Maternity Benefit Act citation + pre-natal (v12 pre-natal worked)
    "Q03": (
    ...
    # "If an employee" framing — echoes question wording
    "Q04": (
