"""
Submission v1 - Basic but Correct
RAG pipeline: PyPDF + simple FAISS similarity search + Groq (llama-3.3-70b)
Chunk size 600, overlap 100, top-k=4
First version I got working after following the LangChain docs.
I tried chunk size 400 first but answers were incomplete, 600 worked better.
"""
import csv, json, sys
...
answers_path = out_dir / "answers_v1.json"
