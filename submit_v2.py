"""
Submission v2 - Overengineered Student
RAG pipeline: BM25 + FAISS EnsembleRetriever hybrid search
Chunk size 1000, overlap 200, top-k=5
I read about BM25 being better for exact keyword matches like policy numbers
so I combined it with FAISS semantic search (0.4 BM25 + 0.6 FAISS weights).
TODO: try semantic caching later to speed this up
"""
import csv, json, sys
...
answers_path = out_dir / "answers_v2.json"
