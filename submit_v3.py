"""
Submission v3 - Late Night Grinder
RAG pipeline: MultiQueryRetriever - generates 3 rephrasings of each question
before searching FAISS. This way if the exact wording doesn't match a chunk,
one of the rephrasings usually does.
Chunk size 1000, overlap 200, top-k=6
I noticed MMR was sometimes missing policy sections when the question
wording was different from the PDF text, so multi-query fixed that.
"""
import csv, json, sys
...
answers_path = out_dir / "answers_v3.json"
