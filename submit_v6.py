"""
Submission v6 - Full PDF extraction alignment
Deep-read all 4 source PDFs verbatim. Fixed:
- Q04: "3 or more consecutive days" (not "more than 2")
- Q08: Added mandatory weekly check-ins + 30-day extension clause
- Q09: Stage 4 has "all L6 and above managers"; numbered 7-stage table
- Q10: 6th criterion = 25 Mbps + dedicated distraction-free workspace (both)
- Q10: Ad-hoc max is 2 days/week + "personal or minor health reasons"
"""
import csv, json, sys
...
answers_path = out_dir / "answers_v6.json"
